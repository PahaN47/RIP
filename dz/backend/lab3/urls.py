...
get_full_order_list = views.SellingViewSet.as_view({
    'get': 'get_full_order_list'
})
...
urlpatterns = [
    ...
    path('cart/add-to-cart', add_to_cart),
    path('cart/get-cart/<int:customer_id>', get_cart),
    path('cart/get-cart-items/<int:cart_id>', get_cart_items),
    path('cart/delete-from-cart/<int:sp_id>', delete_from_cart),
    path('auth/login/', views.auth_login),
    path('auth/create/', views.auth_create),
    path('auth/logout/', views.auth_logout),
    path('selling/full-order-list', get_full_order_list)
]