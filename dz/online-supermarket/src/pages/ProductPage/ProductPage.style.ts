...
export const ProductWrapStyled = styled.div<{ isChange?: boolean | null }>`
...
export const NameInputStyled = styled(SearchInputStyled)``;
...
export const SaveChangesButtonStyled = styled(Link)`
  font-size: 32px;
  line-height: 36px;
  padding: 8px 32px;
  border-radius: 40px;
...
export const StaffButtonWrap = styled.div`
  display: flex;
  flex-direction: row;
  gap: 20px;
`;
